...
temp_type = str(input("Is your temperature in C or F: "))
temp = float(input("Now the temperature please: "))
if temp_type.lower() == "celsius":
    ...
    print("uh... That aint celsius or fahrenheit buddy. Try again next time. - Invalid Input")
...
principal, perc_rate, time_years = map(float, input("Give me your principal, rate(%) and years for this interest calc, all seperated by space: ").split())
